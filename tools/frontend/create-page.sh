...
echo "1. 🔴 RED: Ensure widget exists and start with failing tests"
echo "   - Verify @/widgets/${WIDGET_NAME} is implemented properly"
echo "   - Run: yarn workspace frontend test src/pages/${PAGE_NAME}/ (should pass with mocks)"
echo "2. 🟢 GREEN: Integrate real widget and implement routing"
echo "   - Add route to your router configuration:"
echo "     { path: '/${PAGE_NAME}', element: <${PAGE_PASCAL}Page /> }"
echo "   - Choose the layout that fits your needs:"
echo "     - Simple: ${PAGE_NAME}.tsx"
echo "     - With header/footer: ${PAGE_NAME}-with-layout.tsx"
echo "     - With sidebar: ${PAGE_NAME}-sidebar.tsx"
echo "   - Test navigation and data flow"
echo "3. 🔵 BLUE: Optimize page performance and user experience"
echo "4. Use MCP tools for comprehensive test coverage:"
echo "   - Create decision tables for page state and navigation scenarios"
echo "   - Test responsive behavior across different screen sizes"
echo "   - Generate edge case tests: mcp__testing-mcp__generate_tests"
echo "   - Test accessibility compliance and SEO optimization"
echo "5. Customize the page layout and styling based on design requirements"